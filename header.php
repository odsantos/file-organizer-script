...
<head>
    ...
    <title>
        <?php echo $pageTitle ?? 'File Organizer - Smart File Organization'; ?>
    </title>
    ...
    <meta property="og:description"
        content="A simple utility to automatically organize your files and folders into clean, type-based subdirectories.">
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="/">File Organizer</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#responsive-navbar-nav" aria-controls="responsive-navbar-nav" aria-expanded="false"
                ...
                <div class="collapse navbar-collapse" id="responsive-navbar-nav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="https://odsantos.com">Portfolio</a></li>
                        <li class="nav-item"><a class="nav-link" href="https://odsantos.com/index.php#about">About</a>
                        </li>
                        <li class="nav-item"><a class="nav-link"
                                href="https://odsantos.com/index.php#projects">Projects</a></li>
