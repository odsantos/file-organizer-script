...
<main>
    ...
    <section class="hero-intro">
        <div class="container">
            ...
            <p>A simple utility to automatically organize your files and folders into clean, type-based subdirectories.
            </p>
            <a href="https://osvaldosantos.gumroad.com/l/file-organizer" target="_blank" rel="noopener noreferrer"
                class="cta-button">Download on Gumroad</a>
        </div>
    </section>
    ...
    <div class="container">
        <section id="features">
            ...
            <div class="features-grid">
                ...
                <div class="feature">
                    ...
                    <p>No need to install Python or any other dependencies. Just download and run on Windows or Linux.
                    </p>
                </div>
                <div class="feature">
        ...
        <section id="before-after">
            ...
            <div class="comparison-grid">
                ...
                <div class="comparison-item">
                    <h3>After</h3>
                    <img src="assets/images/after-organizing.png"
                        alt="An organized folder with subdirectories for each file type">
