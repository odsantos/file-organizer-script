<?php
$is_pt_page = true;
$pageTitle = "Política de Privacidade - Organizador de Ficheiros"; include '../header.php'; ?>
<div class="hero-intro">
    <div class="container">
        <h1>Política de Privacidade para o Organizador de Ficheiros</h1>
        <p>A sua privacidade é importante para nós. Esta Política de Privacidade explica como o Organizador de Ficheiros lida com as suas informações.</p>
    </div>
</div>
...
<main class="container privacy-container">
    ...
    <p>Qualquer informação não pessoalmente identificável recolhida (por exemplo, através de análises web) é usada exclusivamente para analisar o desempenho do site, entender o comportamento do utilizador e melhorar o conteúdo e a funcionalidade do site do Organizador de Ficheiros. Se fornecer voluntariamente informações pessoais (por exemplo, através do nosso formulário de contacto), estas serão usadas apenas para o fim para o qual foram fornecidas, como responder às suas questões. Não usamos as suas informações para fins de marketing sem o seu consentimento explícito, e nunca vendemos ou alugamos os seus dados a terceiros.</p>
